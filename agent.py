...
from auxilary import _insert_dim
...
class Agent:
    ...
    def reset(self,batch_size):
        ...
        self.q_eval.reset(batch_size)
        self.resolver.reset(batch_size)
    ...
    def get_sessions(self, 
        ...
        parameters:
            ...
            batch_size - amount of independed sessions
        ...
        state_seq = T.concatenate([_insert_dim(initial_env_state,1),
                           state_seq[:,:-1]],axis=1)
        observation_seq = T.concatenate([_insert_dim(initial_observation,1),
