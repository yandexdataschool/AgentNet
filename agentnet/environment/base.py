...
class BaseEnvironment:
    def __init__(self):
        ...
        please make sure that any non-float environment states are excluded from gradient computation or are cast to floatX.
    ...
    def state_dtypes(self):
        return [theano.config.floatX for obs in self.observation_size]
