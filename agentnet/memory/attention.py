...
class DotAttentionLayer(DictLayer):
    ...
    Unlike AttentionLayer, DotAttention requires you to provide controller_state in the same shape as one 
    ...
    def __init__(self,
        ...
        if use_dense_layer:
            ...
            controller_state = DenseLayer(controller_state,enc_units,
    ...
    def get_output_for(self, inputs, hard_attention=False , **kwargs):
        ...
        logits = T.sum(dec[:, None, :] * enc_seq, axis = -1)  #batch,time
