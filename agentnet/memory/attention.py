...
class AttentionLayer(DictLayer):
    def __init__(self,
        ...
        """
        Implements Bahdanau-style attention. Code mostly inspired by tfnn@yandex.
        ...
        assert len(mask_input.output_shape)==2,"mask_input must be 2-dimensional (batch,time) or None"
    ...
    def get_output_for(self, inputs,**kwargs):
        ...
        probs = T.nnet.softmax(logits)       # [batch_size,seq_len]
